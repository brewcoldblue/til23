...
public class MovieTest {
	public static void main(String[] args) {
		...
		SeriesMovie M2 = new SeriesMovie(2, "타짜", "모름", "액션", 110, 1, "타짜");
		SeriesMovie M3 = new SeriesMovie(3, "타짜2", "모름", "액션", 120, 2, "타짜");
		
		IMovieManagerImpl MM = IMovieManagerImpl.getInstance(); //싱글턴 호출
		IMovieManagerImpl MM2 = IMovieManagerImpl.getInstance(); //싱글턴 호출2
		MM.add(M1);
		MM.add(M2);
		MM.add(M3);
		...
		MM2.add(M1); //싱글턴 테스트
		System.out.println(MM.getInstance() == MM2.getInstance());
